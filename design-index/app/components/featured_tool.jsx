...
export default function FeaturedTool() {
  ...
  <div className="flex flex-col sm:flex-row mt-[30px] w-full h-auto px-[20px] md:px-[10px]">
          <a href={`/tool/${featured?.tool_name.toLowerCase()}`} rel="noopener" className="flex flex-row relative rounded-[15px] shadow-sm border-[1px] border-[#e2e2e2] w-auto xs:w-[380px] h-auto sm:w-[350px] md:w-[400px] xl:w-[450px] xl:h-[150px] 2xl:w-[540px] 2xl:h-[180px] p-[5px] xl:p-[8px] hover:cursor-pointer hover:translate-y-[-2px] transition-all duration-200 ease-in-out ">
            ...
            <img src={featured?.og_image_link} alt={featured?.tool_name} className="w-[180px] h-[100px] sm:w-[200px] sm:h-[130px] xl:w-[250px] xl:h-auto 2xl:w-[300px] rounded-[10px] flex-shrink-0" />
            <div className="flex flex-col mx-[10px] justify-center items-start">
              ...
              <p className="text-[15px] sm:text-[17px] xl:text-[19px] 2xl:text-[21px] font-Outfit font-semibold text-[#595959] leading-[15px] xl:leading-[18px] 2xl:leading-[20px]">{featured?.description}</p>
            </div>
          </a>
          <a href="https://pplx.ai/atharvrem" target="_blank" rel="noopener noreferrer" className="flex flex-row relative rounded-[15px] shadow-sm border-[1px] border-[#e2e2e2] w-auto h-auto xs:w-[380px] sm:w-[350px] md:w-[400px] xl:w-[500px] xl:h-[150px] 2xl:w-[600px] 2xl:h-[180px] p-[5px] xl:p-[8px] mt-[20px] sm:mt-0 sm:ml-[20px] hover:cursor-pointer hover:translate-y-[-2px] transition-all duration-200 ease-in-out">
              ...
              <img src="https://pub-c51f3dea40b34c5f8f4cd14637f22cdc.r2.dev/ad.avif" alt="ad for perplexity" className="w-[180px] h-[100px] sm:w-[200px] sm:h-[120px] xl:w-[250px] xl:h-auto 2xl:w-[300px] rounded-[10px] flex-shrink-0" />
